...
/// A suffix trie.
public struct SuffixTrie<Value> {
    ...
    public func contains<Key>(suffix: Key) -> Bool where Key: StringProtocol {
    ...
    public mutating func remove<Key>(suffix: Key) where Key: StringProtocol {
